                ...
                .then(res => {
                    console.log("The response from adding student", res);
                            ...
                            this.setState({
                                ...
                                completedcourse: '',
                                completedlevel: '',
                                errmsg: "Board member details cannot be empty"
                            })
    ...
    render() {
        ...
        return (
            <div>
                ...
                <h3 className="subhead">Board Member Registration</h3>
                ...
                <form className="inputsection container">
                    ...
                    <button className="createbutton" name="clcreation" onClick={this.handleStudentCreation}>Create Board Memeber  account</button>
                </form>
                <br />
